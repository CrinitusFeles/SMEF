...
class Ui_session_viewer(object):
    def setupUi(self, session_viewer):
        ...
        self.viewer_norma_val_spinbox = QtWidgets.QSpinBox(self.groupBox_5)
        self.viewer_norma_val_spinbox.setMinimum(-199)
        self.viewer_norma_val_spinbox.setMaximum(200)
        self.viewer_norma_val_spinbox.setProperty("value", 0)

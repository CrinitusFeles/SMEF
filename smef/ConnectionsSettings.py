...
class ConnectionsSettings(QWidget, Ui_connections_settings):
    def __init__(self, **kwargs):
        ...
        self.server_ip_line_edit.setText(kwargs.get('server_ip', ''))
        self.s1_port_line_edit.setText(str(kwargs.get('s1_port', 0)))
        self.s2_port_line_edit.setText(str(kwargs.get('s2_port', 0)))
        self.s3_port_line_edit.setText(str(kwargs.get('s3_port', 0)))
        self.s4_port_line_edit.setText(str(kwargs.get('s4_port', 0)))
        self.s5_port_line_edit.setText(str(kwargs.get('s5_port', 0)))
